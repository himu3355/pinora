...
<head>
    ...
    <title>Create Your Account — Pinora</title>
...
<div class="auth-container">
    <div class="auth-header">
        <h1>PINORA</h1>
        <p>Register to manage your orders and speed up checkout</p>
    </div>

    @if(isset($redirect) && $redirect === 'checkout')
    ...
    <div class="auth-footer">
        Already have an account? <a href="{{ route('login', ['redirect' => $redirect ?? '']) }}">Login</a>
    </div>
</div>
